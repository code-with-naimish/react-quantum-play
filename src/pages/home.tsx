      ...
      <section className="mb-10">
        <div className="hero-bg   md:p-12 p-8 overflow-hidden rounded-2xl  ">
          <div className="max-w-lg">
            <h1 className="md:text-5xl text-4xl moveLeftAnimation font-semibold mb-4 ">Next-Gen Gaming, Zero Cost</h1>
            <p className="text-lg moveRightAnimation font-light mb-8 md:max-w-2xl">Experience cutting-edge graphics, intense gameplay, and endless fun — all without spending a dime.</p>
            <Link className="moveBottomAnimation" to="/sort-by/popularity">  <PrimaryBtn title="Explore now" /></Link>
